...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "dl interiors — Residential Interior Design, Johannesburg & Pretoria" },
      { name: "twitter:description", content: "Full turnkey and consultation interior design across residential, corporate, hospitality and retail projects in South Africa." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/198d9ba3-8e9b-4db8-8802-f077861ea6fb/id-preview-61b9d617--f738dd01-a75a-4ea2-994a-4a03a529602f.lovable.app-1783505109219.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/198d9ba3-8e9b-4db8-8802-f077861ea6fb/id-preview-61b9d617--f738dd01-a75a-4ea2-994a-4a03a529602f.lovable.app-1783505109219.png" },
    ],
    links: [
